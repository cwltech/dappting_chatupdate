...
class female_details_provider with ChangeNotifier {
  ...
  Future<void> female_details(String host_id) async {
    String postUrl = "https://hookupindia.in/hookup/ApiController/hostData";
    print("stringrequest");
